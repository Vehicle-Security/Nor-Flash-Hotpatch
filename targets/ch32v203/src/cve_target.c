...
bool cve_target_parse_name(const char *text, cve_target_t *target)
{
    ...
    if ((strcmp(text, "cve2024-2212") == 0) ||
        (strcmp(text, "cve-2024-2212") == 0) ||
        (strcmp(text, "2212") == 0)) {
        *target = CVE_TARGET_CVE2024_2212;
        return true;
    }

    if ((strcmp(text, "cve2025-1674") == 0) ||
        (strcmp(text, "cve-2025-1674") == 0) ||
        (strcmp(text, "1674") == 0)) {
        *target = CVE_TARGET_CVE2025_1674;
        return true;
    }

    if ((strcmp(text, "cve2025-12899") == 0) ||
        (strcmp(text, "cve-2025-12899") == 0) ||
        (strcmp(text, "12899") == 0)) {
...
void cve_target_get_attack_inputs_for(cve_target_t target, cve_target_input_t *input)
{
    if (input == NULL) {
        return;
    }
...
{
    cve_target_get_attack_inputs_for(g_current_target, input);
}
...
void cve_target_print_attack_input(const cve_target_input_t *input)
{
    ...
    if (target == CVE_TARGET_CVE2024_2212) {
        console_printf(
            ...
            (unsigned long)((input != NULL) ? input->queue_length : 0u),
            (unsigned long)((input != NULL) ? input->item_size : 0u));
        return;
    }
