/*
 * queue_demo.c — FreeRTOS-style queue vulnerability simulation (CVE-2024-2212).
 *
 * Demonstrates an integer overflow in (uxQueueLength * uxItemSize) that can
 * be exploited to allocate an undersized buffer, leading to heap corruption.
 * A guard-byte region is placed after the simulated heap to detect overflow.
 */
